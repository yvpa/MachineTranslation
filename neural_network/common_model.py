...
if __name__ == '__main__':
    ...
    target_train_path = f'../data/all-spanish/train.es'
    source_train_path = f'../data/all-spanish/train.all'
    ...
    model.save(f'./models/all-spanish/common_{EPOCHS}_epoch_model')
